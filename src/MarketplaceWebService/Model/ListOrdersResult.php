 ...
 * <li>HasNext: bool</li>
 * <li>OrderInfo: MarketplaceWebService_Model_OrderInfo</li>
 *
 * </ul>
 */ 
class MarketplaceWebService_Model_ListOrdersResult extends MarketplaceWebService_Model
{
    ...
    public function __construct($data = null)
    {
        ...
        'Orders' => array('FieldValue' => array(), 'FieldType' => array('MarketplaceWebService_Model_Order')),
        );
     ...
     * 
     * @return array of Orders Orders
     */
    public function getOrdersList() 
    {
        return $this->fields['Orders']['FieldValue'];
    }

    /**
     * Sets the value of the Orders.
     * 
     * @param mixed Orders or an array of Orders Orders
     * @return this instance
     */
    public function setOrdersList($order) 
    {
        if (!$this->_isNumericArray($order)) {
            $order =  array ($order);    
        }
        $this->fields['OrderInfo']['FieldValue'] = $order;
        return $this;
    }


    /**
     * Sets single or multiple values of Orders list via variable number of arguments. 
    ...
    /**
     * Checks if Orders list is non-empty
     * 
     * @return bool true if Orders list is non-empty
     */
    public function isSetOrders()
    {
        return count ($this->fields['Orders']['FieldValue']) > 0;
    }
